...
Caso a API não esteja disponível, os óculos podem ser arrastados manualmente na tela.
Se ocorrer algum problema (por exemplo, falha ao carregar o modelo 3D ou câmera indisponível), uma mensagem de erro é exibida no topo da página.
